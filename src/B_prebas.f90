...
!!!ground vegetation variables
 ...
 real (kind=8), intent(inout) :: output(nYears, nVar, nLayers, 2) ! last dimension: 1 is for stand and 2 is for harvested sum of wood.
 real (kind=8), intent(inout) :: energyWood(nYears, nLayers, 17, 2) ! jhassort: increase n of vars (17), last dimension: 1=harvested/realised, 2=standing/potential assortments
